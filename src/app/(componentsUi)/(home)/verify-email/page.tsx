...
const EmailVerification = () => {
    ...
    >
      <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
        ...
        <p className="text-gray-600 mb-4">
          If you're experiencing issues with email verification, please contact
          our support team:
        </p>
  ...
  const Toast = () => (
    <div
      className={`fixed top-4 right-4 bg-green-500 text-white px-6 py-3 rounded-lg shadow-lg transition-opacity duration-300 ${
      ...
      <main className="container mx-auto px-4 py-8 max-w-2xl">
        {verificationStatus === "loading" ? (
          ...
          <div className="text-center">
            ...
            <Link
              href="/login"
              className="bg-green-600 text-white px-8 py-3 rounded-lg hover:bg-green-700 transition-colors w-full sm:w-auto"
            >
              Go to Login
            </Link>
          </div>
