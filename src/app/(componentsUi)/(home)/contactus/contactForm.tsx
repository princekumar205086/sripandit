...
const ContactForm = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-cream">
      <div className="w-full md:w-1/2 p-12 bg-cream shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-3 py-2 rounded-lg border-2 text-orange-400 border-gray-200 outline-none focus:border-indigo-500 transition-colors"
              required
          ...
          <div className="relative">
            ...
            <input
              ...
              className={`w-full pl-10 pr-3 py-2 rounded-lg border-2 text-orange-400 ${
          ...
          <div className="relative">
            <FaCommentAlt className="absolute top-3 left-3 text-orange-400" />
            <textarea
              value={message}
      ...
      <div className="w-full md:w-1/2 bg-indigo-100 flex items-center justify-center p-8">
        <div className="relative w-full h-full overflow-hidden rounded-lg shadow-xl transform transition-all duration-300 hover:scale-105">
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-transparent opacity-90">
            <h3 className="text-4xl bg-trans p-2 bg-opacity-80 font-bold text-orange-700 text-center">
              We're here to help!
            </h3>
          </div>
        </div>
