    ...
    <>
      ...
      <div className="bg-redOrange min-h-screen font-sans">
        ...
        <main className="container mx-auto px-4 py-8">
          <section id="job-openings" className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {jobs.map((job) => (
                ...
                >
                  <h3 className="text-xl font-semibold mb-2 text-orangeRed">
                    {job.title}
                  </h3>
                  <p className="text-orangeRed mb-4">{job.description}</p>
                  <p className="text-sm text-orangeRed mb-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-cream rounded-lg shadow-md p-6 flex flex-col items-center text-center">
                ...
                <p className="text-orange-400">
                  Make a difference in people's spiritual lives
                </p>
              </div>
              <div className="bg-cream rounded-lg shadow-md p-6 flex flex-col items-center text-center">
          ...
          >
            <h2 className="text-3xl font-bold mb-6 text-orangeRed">
              Application Form
            </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full border rounded px-4 py-2 focus:outline-none focus:ring-2 text-orangeRed ${
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className={`w-full border rounded px-4 py-2 focus:outline-none focus:ring-2 text-orangeRed ${
                      errors.selectedJob ? "border-red-500" : "border-gray-300"
                    }`}
                  >
