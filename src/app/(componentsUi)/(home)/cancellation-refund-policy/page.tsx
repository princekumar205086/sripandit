  ...
  const cancellationRefundPolicyContent: TermContent[] = [
    {
      ...
      title: "Introduction",
      content:
        "This Cancellation/Refund Policy outlines the terms and conditions for canceling services and requesting refunds at OKPUJA. By using our services, you agree to the terms of this policy.",
    },
    {
      id: 2,
      title: "Cancellation Policy",
      content:
        "You may cancel your booking up to 24 hours before the scheduled service time. Cancellations made within 24 hours of the service time may not be eligible for a refund.",
    },
    {
      id: 3,
      title: "Refund Policy",
    ...
    },
    {
      ...
      content:
        "Certain services may be non-refundable. These services will be clearly marked as non-refundable at the time of booking.",
    },
    {
      id: 5,
      title: "Contact Us",
      content:
        "If you have any questions or concerns regarding this Cancellation/Refund Policy, please contact us at support@okpuja.com.",
    },
  ];

  const filteredContent = cancellationRefundPolicyContent.filter((item) =>
