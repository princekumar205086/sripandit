...
const QualifiedPandit = () => {
  return (
    ...
    >
      <div className="relative h-full flex flex-col justify-center items-center text-center text-orange-500 px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-2 bg-opacity-60 bg-black p-2 text-orange-500">
          Are you a qualified Pandit/Astrologer?
        </h2>
        <button className="bg-cream hover:bg-red-600 hover:text-white text-orange-500 font-bold py-3 sm:py-4 md:py-5 lg:py-6 xl:py-7 px-5 sm:px-6 md:px-7 lg:px-8 xl:px-9 rounded-lg transition duration-300 ease-in-out m-4 transform hover:scale-105">
          Send a request
        </button>
        <p className=" p-2 text-sm sm:text-md md:text-lg lg:text-xl xl:text-2xl bg-opacity-60 bg-black">
